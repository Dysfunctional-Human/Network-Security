...
from networksecurity.entity.config_entity import DataIngestionConfig ## configuration for the Data Ingestion Config
import os
import sys
import pymongo
import numpy as np
...
class DataIngestion:
    ...
    def split_data_as_train_test(self, df: pd.DataFrame):
        try:
            train_set, test_set = train_test_split(
                df, test_size=self.data_ingestion_config.train_test_split_ration
            )
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            df = self.export_data_into_feature_store(df=df)
